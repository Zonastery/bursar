...
ERROR_CASES = [
    ...
    (CatalogNotLoadedError("failure"), "CATALOG_NOT_LOADED", "unavailable", 503, False),
    ...
    (CapabilityNotConfiguredError("billing"), "CAPABILITY_NOT_CONFIGURED", "unavailable", 503, False),
    ...
    (PaymentMethodRequiredError(), "PAYMENT_METHOD_REQUIRED", "payment_required", 402, False),
