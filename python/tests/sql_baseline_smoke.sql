...
BEGIN
    PERFORM bursar.publish_and_activate_catalog(
        ...
        '{
          "version": 1,
          "credits": {
            "buckets": {"included": {}, "purchased": {}},
            "spend_order": ["included", "purchased"],
            "default_bucket": "purchased",
            "overdraft_bucket": "purchased",
            "signup_grant": {"amount": 2, "bucket": "included"}
          },
          "plans": {
            "pro": {
              "display_name": "Pro",
              "spending": {"mode": "overdraft", "overdraft_limit": 20, "max_concurrent": 1}
            }
          },
          "payments": {"subscriptions": {}, "topups": {}}
        }'::jsonb,
        'smoke'
    );
