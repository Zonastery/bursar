...
```python
from decimal import Decimal
from ducto import CreditManager, LowBalanceConfig
...
```typescript
import { CreditManager, LowBalanceConfig } from "@apoorwv/ducto";
