...
bursar for Python is published as the [`bursar`](https://pypi.org/project/bursar/) package on PyPI. Requires Python 3.11+.
...
| Model | Description |
|-------|-------------|
| `BursarConfigData` | Pricing config schema (models, tools, search, cache, fixed, plans) |
...
| `TierDefinition` | [Credit tier](/docs/configuration#credit-tiers) definition (priority, expiry, default/overdraft flags) |
