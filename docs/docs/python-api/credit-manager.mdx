...
| --- | --- | --- |
| `add_credits` | `user_id: str`, `amount: Decimal \| int`, `*, entry_type="adjustment"`, `metadata`, `expires_at`, `bucket`, `idempotency_key` | `AddCreditsResult` |
...
| `deduct_flat_job` | `user_id: str`, `amount: Decimal \| int`, `idempotency_key=None`, `metadata=None`, `*, feature=None` | `DeductionResult` |
