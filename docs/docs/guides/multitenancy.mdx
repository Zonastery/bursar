...
- Install the Bursar CLI and prepare separate migration, operator, and application runtime PostgreSQL credentials — see the [CLI reference](../cli.mdx).
...
3. Applications that also need to publish initial pricing can use the
