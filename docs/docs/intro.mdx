...
The current documentation tracks Bursar 1.x. Docusaurus version snapshots will be added only when a future major release changes user-facing behavior.
...
- Read [The Bursar data model](./concepts/data-model.mdx) to understand accounts, ledger entries, lots, leases, and allowances
