...
```typescript
import { CreditManager, UsageMetrics, HttpxSupabaseStore } from "@zonastery/bursar";
...
- [Architecture](/docs/architecture) — how bursar works under the hood
