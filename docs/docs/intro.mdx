...
<img
  className="bursar-docs-logo"
  src={useBaseUrl('/img/logo.png')}
  alt="Bursar logo: a smiling orange wallet holding credit cards and coins"
  width={1024}
  height={1024}
  loading="eager"
  decoding="async"
...
| Database | PostgreSQL 16+ + pg_partman 5.x + pg_jsonschema 0.3+ | one `bursar` schema, one migration runner |
